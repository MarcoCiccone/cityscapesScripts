...
labels = [
    ...
    Label(  'rail track'           , 10 ,      11 , 'flat'            , 1       , False        , True         , (230,150,140) ),
    ...
    Label(  'guard rail'           , 14 ,      11 , 'construction'    , 2       , False        , True         , (180,165,180) ),
    ...
    Label(  'license plate'        , -1 ,       11 , 'vehicle'         , 7       , False        , True         , (  0,  0,142) ),
]
